...
export default function Home() {
  const gradientId =
    "whatsapp-gradient-" + Math.random().toString(36).substr(2, 9);
  const shadowId = "whatsapp-shadow-" + Math.random().toString(36).substr(2, 9);
  return (
    <>
      <Navbar />
      <HeroesSection />
      ...
      <div
        className="fixed bottom-0 right-0 m-4 md:bottom-10 md:right-16 lg:right-24 z-[9999] cursor-pointer hover:scale-110 transition-transform duration-200 ease-in-out"
        onClick={() => {
          window.open(
